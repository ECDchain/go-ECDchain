...
import (
	...
	"github.com/turingcontract/go-turingcontract/internal/build"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/turingcontract/go-turingcontract/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/turingcontract/go-turingcontract/mobile")
