...
type ChainConfig struct {
	...
	EthzeroTOSBlock *big.Int `json:"turingcontractBlock,omitempty"` // Ethzero trial operation stage switch block (nil = no fork, 0 = already on turingcontract)
	EthzeroBlock *big.Int `json:"turingcontractBlock,omitempty"` // Ethzero switch block (nil = no fork, 0 = already on turingcontract)
	EthzeroGenesisBlock *big.Int `json:"turingcontractGenesisBlock,omitempty"` // Ethzero switch block (nil = no fork, 0 = already on turingcontract)
