...
import (
	...
	"github.com/turingcontract/go-turingcontract/ethclient"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/turingcontract/go-turingcontract/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
